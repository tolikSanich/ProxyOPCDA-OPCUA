 ...
 * <p>
 * Definition from MSDN: <i> ITypeInfo, an interface typically used for reading
 ...
 * of objects from type libraries. Type information interfaces are intended to
 * describe the parts of the application that can be called by outside clients,
 ...
 * interfaces, this contains the set of member functions in the interface.
 * <li>The set of data member descriptions associated with the type. For
 * structures, this contains the set of fields of the type.
 * <li>The general attributes of the type, such as whether it describes a
 * structure, an interface, and so on. </i>
 * <p>
...
public interface IJITypeInfo extends IJIComObject
{
     ...
     * 
     * @param index
     *            index of the function whose description is to be returned. The
     ...
     * and the context ID for the Help
     ...
     * 
     * @param memberId
     *            ID of the member function whose DLL entry description is to be
     *            returned.
     * @param invKind
     *            Specifies the kind of member identified by
     *            <code>memberId</code>. This is important for properties,
     ...
     * 
     * @param index
     *            index of the variable whose description is to be returned. The
     *            index should be in the range
     ...
     * property or method and its parameters)
     * that correspond to the specified function ID. <br>
     * 
     * @param memberId
     *            ID of the member whose name (or names) is to be returned.
     * @param maxNames
     ...
     * interface types. For an interface, getRefTypeOfImplType returns the type
     * information for inherited interfaces,
     * if any exist. <br>
     * 
     * @param index
     *            index of the implemented type whose handle is returned. The
     *            valid range is 0 to the
     ...
     * 
     * @param index
     *            index of the implemented interface or base interface for which
     *            to get the flags.
     * @return
     * @throws JIException
     */
     ...
     * 
     * @param memberId
     *            member ID that indicates which marshaling information is
     *            needed.
     * @return
     * @throws JIException
     */
