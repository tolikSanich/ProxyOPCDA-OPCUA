...
public interface IJIEnumVariant
{
     ...
     * of elements remain in the sequence, Next returns only the remaining
     * elements.
     * </i>
     * 
     * @param celt
     ...
     * guarantee that exactly the same set of
     * variants will be enumerated the second time as was enumerated the first
     * time. Although an exact duplicate
     * is desirable, the outcome depends on the collection being enumerated. You
     * may find that it is impractical
     * for some collections to maintain this condition (for example, an
     * enumeration of the files in a directory).
     * </i>
     * 
     * @throws JIException
     */
     ...
     * a particular point in the enumeration
     * sequence can be recorded, and then returned to at a later time. The
     * returned enumerator is of the same actual
