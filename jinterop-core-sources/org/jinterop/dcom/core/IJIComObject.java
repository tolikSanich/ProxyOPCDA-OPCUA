 ...
 * {@link org.jinterop.dcom.impls.JIObjectFactory#buildObject(JISession, byte[])}
 * </li>
 ...
 * before being casted to the expected type. <br>
 * </p>
 * <p>
 * Sample usage :- <br>
 * <code>
...
public interface IJIComObject extends Serializable
{
     ...
     *             with this object or this object represents a local java
     *             reference.
     ...
     * value can
     * and should be used to map an <code>IJIUnreferenced</code> handler
     * implementation to this COM Object.
     * <p>
     ...
     * 
     * @param obj
     *            call builder carrying all information necessary to make the
     *            call successfully.
     ...
     *            call successfully.
     * @param timeout
     *            timeout for this call in milliseconds, overrides the instance
     *            level
     ...
     * is used during all socket level operations such as
     * {@link #call(JICallBuilder)} , {@link #queryInterface(String)} etc.
     * 
     ...
     * when this comObject goes
     * out of reference and is removed from it's session by the library. Only a
     * single handler can be
     * added for each object. If a handler for this object already exists , it
     * would be replaced by this
     * call.
     * 
     * @param unreferenced
     *            handler to get notification when reference count for this
     *            object hits 0 and is
