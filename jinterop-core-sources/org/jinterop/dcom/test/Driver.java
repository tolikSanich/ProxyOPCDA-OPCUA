...
class Driver implements iota
{
    ...
    public static void main ( final String[] args )
    {
        try
        {
            ...
            final String n = "variant[index]sss".replaceFirst ( "index", Integer.toString ( 100 ) );
            final Short xxxs = new Short ( (short)1 );
            ...
            if ( ccccccc.isArray () )
            {
                final String name2 = ccccccc.getName ();
                final int i = name2.lastIndexOf ( "L" );
            ...
            while ( d != null )
            {
                final Class dd = d.getComponentType ();
                if ( dd == null )
                {
            ...
            final JIArray arrrry = new JIArray ( new Long[][] { { new Long ( 1 ), new Long ( 2 ) }, { new Long ( 3 ), new Long ( 4 ), new Long ( 5 ) }, { new Long ( 3 ), new Long ( 4 ), new Long ( 5 ) } } );
            ...
            while ( name.startsWith ( "[" ) )
            {
                ...
                final int x = Array.getLength ( subArray );
            ...
            final int[] upperBounds = new int[upperBounds2.size ()];
            ...
            final Object newArray = createArray ( new Long[][] { { new Long ( 1 ), new Long ( 2 ) }, { new Long ( 3 ), new Long ( 4 ), new Long ( 5 ) }, { new Long ( 3 ), new Long ( 4 ), new Long ( 5 ) } }, long.class, dimension );

            final int[][] g1 = new int[10][10];
            final Integer[][] g = new Integer[10][10];

            Array.set ( g, 0, Array.get ( g1, 0 ) );

            final Class cx = ccccccc.getComponentType ();
            final Object rrr = new Integer ( 0 );
            // System.out.println(rrr.getClass().getSimpleName());
            System.out.println ( rrr.getClass () );
            //Object hhhhh = Integer.class.cast(rrr);
            final IJIUnsigned un = JIUnsignedFactory.getUnsigned ( new Long ( 100 ), JIFlags.FLAG_REPRESENTATION_UNSIGNED_INT );
            System.out.println ( un.getClass () );
            final Class xx = void.class;
            final Integer y = new Integer ( 123 );
            final Class xxxx = y.getClass ();
            System.out.println ( xxxx.isPrimitive () );
            final Constructor cc = JIVariant.class.getConstructor ( new Class[] { int.class, boolean.class } );
            final JIVariant vv = (JIVariant)cc.newInstance ( new Object[] { y, Boolean.valueOf ( true ) } );
            final Object o007 = new Integer ( 1 );
            Driver.cc ( o007 );
            if ( int.class == Integer.class )
            {
                System.out.println ( "same" );
            }
            final Object o123 = new int[][] { { 1, 2 }, { 2, 3 } };
            final Object o1234 = o123;
            Class c = o1234.getClass ();
            final Object o234 = Array.get ( o123, 0 );
            c = o234.getClass ();
            System.out.println ( o123.getClass () );

            final String[] str = "123.9".split ( "\\." );
            ...
            final Object o = Array.newInstance ( IJIDispatch.class, 10 );

            final iota[] s = new Driver[100];
            System.out.println ( s.getClass ().getComponentType () );
            JISystem.getErrorMessages ();
            final Byte[][] bgh = new Byte[10][0];
            final long jj = 2147483670L;
            final short b = (short)40000;
            final byte b1123 = (byte)b;
            final String msd = null + "";
            ...
            //			  System.out.println(str);
            final Object[][] obj = new Object[6][2];
            System.out.println ( obj.length );
            final int lowbyte = -12345678;
            //lowbyte = (int)(lowbyte - lowbyte%10000);
            final double lowbyte1 = lowbyte % 10000.0;
            final UUID uuid = new UUID ();
            System.out.println ( uuid.toString () );
            final int toSend = 0xFFFFFFFF;
            System.out.println ( Integer.toHexString ( toSend ) );
            final double gss = 100020 % 10000;
            final String toSend2 = Integer.toHexString ( toSend );
            final byte[] hibuffer = new byte[] { 0, 0, 0, 0, 0, 0, 0, 0 };
            final byte[] lowbuffer = new byte[] { 0, 0, 0, 0, 0, 0, 0, 0 };
            final String lo = "";
            if ( toSend2.length () > 8 )
            {
            ...
            final byte[] buffer = new byte[1148];//1144
            ...
            final Integer yx[] = new Integer[] { new Integer ( 19 ), new Integer ( 20 ), new Integer ( 22 ), new Integer ( 23 ) };
            computeLengthArray ( yx );
            final Double yx2[][] = new Double[][] { new Double[] {}, new Double[] { new Double ( 123.3 ), new Double ( 123.4 ), new Double ( 123.5 ) }, new Double[] {} };
            computeLengthArray ( yx2 );
            //				serializeArray(yx);
            //
            final Object array = deSerializeArray ( Float.class, new int[] { 10, 20 }, 2 );
            ...
            final byte b1[] = new byte[10];//{(byte)0x9c,(byte)0x3f,(byte)0x16,(byte)0};
            final int val = Encdec.dec_uint32le ( b1, 0 );
            ...
            final char buffer1[] = { '0', 'x', '0', '0', '0', '0', '0', '0', '0', '0' };
            ...
            final FirstContact_Stub test = new FirstContact_Stub ( "estroopchandxp" );
    ...
    static Object createArray ( final Object srcArray, final Class targetArrayType, final int dimension )
    {
        Object array = null;
        Class c = targetArrayType;
        final int len = Array.getLength ( srcArray );
        ...
        for ( int i = 0; i < len; i++ )
        {
            if ( dimension == 1 )
            {
                ...
                if ( i == Array.getLength ( srcArray ) )
                {
                    ...
                    //resize it.
                    final Object array2 = Array.newInstance ( targetArrayType, i );
    ...
    static void serializeArray ( final Object array )
    {
    ...
    static int computeLengthArray ( final Object array )
    {
        int length = 0;
        final String name = array.getClass ().getName ();
        final Object o[] = (Object[])array;
    ...
    static Object deSerializeArray ( final Class arrayType, final int[] upperBounds, final int dimension )
    {
        Object array = null;
        Class c = arrayType;
        for ( int j = 0; j < dimension; j++ )
    ...
    public static void cc ( final Integer i )
    {
        System.out.println ( i + " , " + i.getClass () );
    }

    public static void cc ( final Object i )
    {
        System.out.println ( i + " () , " + i.getClass () );
    }
