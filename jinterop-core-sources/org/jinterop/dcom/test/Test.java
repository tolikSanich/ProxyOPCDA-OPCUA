...
public class Test
{
    ...
    public static void main ( final String[] args )
    {
        try
        {
            ...
            final boolean b = null instanceof JIComServer ? false : true;
            ...
            final UniAddress mydomaincontoller = UniAddress.getByName ( "itl-hw-lt15522" );
            final NtlmPasswordAuthentication mycreds = new NtlmPasswordAuthentication ( "itl-hw-lt15522", "TestUser", "Enabler2000" );
            SmbSession.logon ( mydomaincontoller, mycreds );
